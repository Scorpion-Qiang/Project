 ...
 * Time: 18:48
 */
public class ProblemReviewDao {
    // 1. 查询某个题目所有的评论（underId = 0，一级评论；underId != 0，二级评论）
    public List<ProblemReview> selectProblemReview(int problemId, int underId){
        Connection connection = null;
        PreparedStatement statement = null;
        ResultSet resultSet = null;

        List<ProblemReview> res = new ArrayList<>();

        try {
            connection = DBUtil.getConnection();

            String sql = "select id, username, content, time, sendto from problemreview where problemId = ? and underId = ? order by time desc";
    ...
    // 2. 根据 id 查找某个评论
    public ProblemReview selectOneProblemReview(int id){
        Connection connection = null;
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        ...
        try {
            ...
            String sql = "select id, username, content, time from problemreview where id = ?";
            statement = connection.prepareStatement(sql);
    ...
    public void deleteProblemReview(int id){
        Connection connection = null;
        PreparedStatement statement = null;
        ...
        try {
            ...
            String sql = "delete from problemreview where id = ? or underId = ?";
            statement = connection.prepareStatement(sql);
            statement.setInt(1, id);
    ...
    // 4. 新增评论
    public void insertProblemReview(ProblemReview review){
        Connection connection = null;
        PreparedStatement statement = null;
    ...
    // 5. 某个题目所有评论的数量
    public int selectProblemReviewCount(int problemId){
        Connection connection = null;
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        ...
        try {
            ...
            String sql = "select count(*) as num from problemreview where problemId = ?";
            statement = connection.prepareStatement(sql);
            statement.setInt(1, problemId);
    ...
    public void updateUserName(String newName, String priorName){
        ...
        try {
            ...
            String sql = "update problemreview set username = ? where username = ?";
            statement = connection.prepareStatement(sql);
    ...
    public static void main(String[] args) {
        ...
        String content = "我爱你到天荒";
        review.setContent(content);
        System.out.println(content.getBytes().length);


        problemReviewDao.insertProblemReview(review);
    }
}
